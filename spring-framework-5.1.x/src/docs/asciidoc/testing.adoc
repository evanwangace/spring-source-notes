...
----
	@RunWith(SpringRunner.class)
	// ApplicationContext will be loaded from "/MyConfig.groovy" and
	// "/TestConfig.groovy" in the root of the classpath
	@ContextConfiguration({"/MyConfig.groovy", "/TestConfig.Groovy"}) <1>
	public class MyTest {
		// class body...
	}
----
...
----
	@RunWith(SpringRunner.class)
	// ApplicationContext will be loaded from MyConfig and TestConfig
	@ContextConfiguration(classes = {MyConfig.class, TestConfig.class}) <1>
	public class MyTest {
		// class body...
	}
----
